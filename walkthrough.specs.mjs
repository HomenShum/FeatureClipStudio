...
export const SPECS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { cap: "You land in a real room: a spreadsheet, notes, and your teammates working live.", cursor: "text=Q3 diligence", hold: 92 },
      ...
      { act: "sleep", ms: 800 },
      { cap: "You asked the room's AI to research a company — and here is its answer, sources attached.", cursor: "text=structured fields", hold: 100 },
